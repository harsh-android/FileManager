...
-keep class filemanager.harshapp.hm.fileexplorer.BuildConfig { *; }
...
-keepnames class filemanager.harshapp.hm.fileexplorer.AboutActivity
...
-repackageclasses filemanager.harshapp.hm.fileexplorer
