...
import filemanager.harshapp.hm.fileexplorer.ui.CircleImage;
...
public class DetailFragment extends DialogFragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        iconMimeBackground.setBackgroundColor(IconColorUtils.loadMimeColor(getActivity(), doc.mimeType, doc.authority, doc.documentId, SettingsActivity.getAccentColor()));
