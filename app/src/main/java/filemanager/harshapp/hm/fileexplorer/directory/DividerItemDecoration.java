...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public void setInset(int leftInset, int rightInset) {
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            final int right = mRightInset + mBounds.right + Math.round(child.getTranslationX());
            final int left = mLeftInset + right - mDivider.getIntrinsicWidth();
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        ...
        //noinspection AndroidLintNewApi - NewApi lint fails to handle overrides.
        if (parent.getClipToPadding()) {
            left = mLeftInset + parent.getPaddingLeft();
            right = mRightInset + parent.getWidth() - parent.getPaddingRight();
            canvas.clipRect(left, parent.getPaddingTop(), right,
                    parent.getHeight() - parent.getPaddingBottom());
        } else {
            left = mLeftInset;
            right = mRightInset + parent.getWidth();
        }
