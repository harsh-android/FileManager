package filemanager.harshapp.hm.fileexplorer.setting;
...
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_ACCENT_COLOR;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_ADVANCED_DEVICES;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_FILE_HIDDEN;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_FILE_SIZE;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_FILE_THUMBNAIL;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_FOLDER_ANIMATIONS;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_FOLDER_SIZE;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_PRIMARY_COLOR;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_RECENT_MEDIA;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_ROOT_MODE;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_SECURITY_ENABLED;
import static filemanager.harshapp.hm.fileexplorer.setting.SettingsActivity.KEY_THEME_STYLE;
