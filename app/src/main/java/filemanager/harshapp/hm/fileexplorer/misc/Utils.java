...
public class Utils extends UtilsFlavour{
    ...
    public static final String INTERSTITIAL_APP_UNIT_ID = "ca-app-pub-3940256099942544/1033173712";
    ...
    public static Uri getAppProStoreUri(){
        if(isAmazonBuild()){
            return Uri.parse("https://play.google.com/store/apps/details?id=" + BuildConfig.APPLICATION_ID+".pro" + "&showAll=1");
        }
    ...
    public static void openFeedback(Activity activity){
        sendEmail(activity, "Send Feedback", "AV File Manager");
    }
    ...
    public static void sendEmail(Activity activity, String title, String subject){
        ...
        result.putExtra(Intent.EXTRA_EMAIL, new String[]{"support@appvision.in"});
        result.putExtra(Intent.EXTRA_SUBJECT, subject);
        result.putExtra(Intent.EXTRA_TEXT, "AV File Manager"
