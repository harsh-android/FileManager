...
import filemanager.harshapp.hm.fileexplorer.misc.ImageUtils;
import filemanager.harshapp.hm.fileexplorer.misc.OsCompat;
import filemanager.harshapp.hm.fileexplorer.misc.Utils;
import filemanager.harshapp.hm.fileexplorer.provider.DocumentsProvider;
import filemanager.harshapp.hm.fileexplorer.provider.ExternalStorageProvider;
import filemanager.harshapp.hm.fileexplorer.provider.UsbStorageProvider;

import static filemanager.harshapp.hm.fileexplorer.misc.ContentProviderClientCompat.buildAssetFileDescriptor;
import static filemanager.harshapp.hm.fileexplorer.misc.ContentProviderClientCompat.openTypedAssetFileDescriptor;
...
public final class DocumentsContract {
     ...
     */
    public static final String PROVIDER_INTERFACE = "dev.dworks.apps.anexplorer.action.DOCUMENTS_PROVIDER";
     ...
     * {@link filemanager.harshapp.hm.fileexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID}.
     *
    ...
    /**
     * Build URI representing the target {@link filemanager.harshapp.hm.fileexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} in
     * a document provider. When queried, a provider will return a single row
     * with columns defined by {@link filemanager.harshapp.hm.fileexplorer.model.DocumentsContract.Document}.
     *
     ...
     * Build URI representing the children of the target directory in a document
     * provider. When queried, a provider will return zero or more rows with
     * columns defined by {@link filemanager.harshapp.hm.fileexplorer.model.DocumentsContract.Document}.
     * <p>
     ...
     *            directory with MIME type of {@link filemanager.harshapp.hm.fileexplorer.model.DocumentsContract.Document#MIME_TYPE_DIR}.
     * @see android.content.Intent#ACTION_OPEN_DOCUMENT_TREE
     * @see android.provider.DocumentsProvider#isChildDocument(String, String)
    ...
    /**
     * Extract the {@link filemanager.harshapp.hm.fileexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     *
    ...
    /**
     * Extract the via {@link filemanager.harshapp.hm.fileexplorer.model.DocumentsContract.Document#COLUMN_DOCUMENT_ID} from the given URI.
     */
