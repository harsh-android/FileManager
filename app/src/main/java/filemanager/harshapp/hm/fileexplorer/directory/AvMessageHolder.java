...
public class AvMessageHolder extends BaseHolder {

    final ImageView icon;
    final TextView title;
    final View background;

    public AvMessageHolder(DocumentsAdapter.Environment environment, Context context,
    ...
    public AvMessageHolder(DocumentsAdapter.Environment environment, Context context, ViewGroup parent) {
